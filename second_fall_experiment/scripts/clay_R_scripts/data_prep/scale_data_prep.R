...
wd <- "/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/data/scale_output/read_only/"
setwd(wd)
...
# write.csv(maria_scaledat, "/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/data/scale_output/maria_scale_data_raw_compiled.csv", row.names = F)
...
saveRDS(scaledat, "/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/data/scale_output/scale_data_compiled_raw_long.rds")
...
saveRDS(scaledat, "/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/data/scale_output/scale_data_raw_compiled_long.rds")

# read data back in
# scaledat <- readRDS("/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/data/scale_output/scale_data_raw_compiled_long.rds")


### ---- Aggregate (15 minutes) and Flag 

# source the function 'aggAndFlag'
source("/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/scripts/clay_R_scripts/data_prep/flagging_functions.R")
...
saveRDS(aggDat, "/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/data/scale_output/scale_data_long_aggflag.rds")

# read back in
# aggDat <- readRDS("/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/data/scale_output/scale_data_long_aggflag.rds")
...
saveRDS(scaledat_wide, "/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/data/scale_output/scale_data_30second_wide.rds")
...
# write.csv(maria_scaledat_wide, "/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/data/scale_output/scale_data_30second_wide_maria.csv", row.names = F)
# read data back in 
# scaledat_wide <- readRDS("/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/data/scale_output/scale_data_30second_wide.rds")
...
saveRDS(weights15, '/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/data/scale_output/scale_data_compiled_15min_means.rds')

flags_overall_2 <- as.data.frame(flags_overall)
flags_overall_2$by15 <- weights15$by15
saveRDS(flags_overall_2, '/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/data/scale_output/scale_data_compiled_15min_means_FLAGS.rds')
...
source("/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/scripts/clay_R_scripts/data_prep/timeSeriesAvg_fun.R")

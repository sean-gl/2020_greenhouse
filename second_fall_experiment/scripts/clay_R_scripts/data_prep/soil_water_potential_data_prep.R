...
swp_block_D <- read.csv('/home/sean/github/2020_greenhouse/second_fall_experiment/data/soil_water_potential/read_only/CR1000_GH_A_Matric_159.dat', 
...
swp_block_M <-  read.csv('/home/sean/github/2020_greenhouse/second_fall_experiment/data/soil_water_potential/read_only/CR1000_GH_D_Matric_158.dat', 
                         skip = 1, header = T, stringsAsFactors = F) 
swp_block_M <- swp_block_M[-c(1:2),] # omit 1st row, is units
head(swp_block_M); tail(swp_block_M)

# "B_C" file = block W (east side)
swp_block_W <-  read.csv('/home/sean/github/2020_greenhouse/second_fall_experiment/data/soil_water_potential/read_only/CR1000_GH_BC_Matric_901.dat', 
                         skip = 1, header = T, stringsAsFactors = F) 
...
write.csv(swp, '/home/sean/github/2020_greenhouse/second_fall_experiment/data/soil_water_potential/soil_water_potential_compiled.csv',
          row.names = F)
...
saveRDS(swp, '/home/sean/github/2020_greenhouse/second_fall_experiment/data/soil_water_potential/soil_water_potential_compiled_condensed.rds')
write.csv(swp, '/home/sean/github/2020_greenhouse/second_fall_experiment/data/soil_water_potential/soil_water_potential_compiled_condensed.csv',
        row.names = F)

...
baldat <- readRDS('/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/data/scale_output/scale_data_long_aggflag.rds')
...
saveRDS(transp, '/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/analysis/clay/output_data/transpiration_by_plant.rds')
...
saveRDS(aggdat, '/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/analysis/clay/output_data/transpiration_by_plant.rds')


### Now, read in combined data (plus psi_leaf predictions) and merge to transpiration data (at block-level)
combdat <- readRDS('/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/analysis/clay/output_data/combined_data_predicted_psi_leaf.rds')
...
saveRDS(alldat, '/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/analysis/clay/output_data/combined_data_predict_psi_leaf_transpiration.rds')

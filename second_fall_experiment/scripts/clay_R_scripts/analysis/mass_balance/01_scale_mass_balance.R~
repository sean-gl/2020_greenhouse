rm(list=ls())
packages <- c('lubridate','plyr','ggplot2','car')
...
pot_wt <- readRDS('/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/scripts/clay_R_scripts/analysis/mass_balance/saturated_pot_weights.rds')

# Read in end-of-experiment plant wet weights
plant_wt <- read.csv('/home/wmsru/Documents/Clay/greenhouse_2019/second_fall_experiment/data/end_of_experiment_plant_wet_weights.csv',

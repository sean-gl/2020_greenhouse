...
swp <- readRDS('/home/sean/github/2020_greenhouse/second_fall_experiment/data/soil_water_potential/soil_water_potential_compiled_condensed.rds')

# read in raw scale data
bal <- readRDS('/home/sean/github/2020_greenhouse/second_fall_experiment/data/scale_output/scale_data_raw_compiled_long.rds')

# read 15-min means scale data
bal.15 <- readRDS('/home/sean/github/2020_greenhouse/second_fall_experiment/data/scale_output/scale_data_long_aggflag.rds')
...
pdf('/home/sean/github/2020_greenhouse/second_fall_experiment/figures/clay_figures/soil_water_potential/Rplot_d11_teros_v_scale_t1.pdf',
    width=10, height=7)
...
pdf('/home/sean/github/2020_greenhouse/second_fall_experiment/figures/clay_figures/soil_water_potential/Rplot_m7_teros_v_scale_t1.pdf',
    width=10, height=7)
...
pdf('/home/sean/github/2020_greenhouse/second_fall_experiment/figures/clay_figures/soil_water_potential/Rplot_d11_teros_v_scale_t2.pdf',
    width=10, height=7)

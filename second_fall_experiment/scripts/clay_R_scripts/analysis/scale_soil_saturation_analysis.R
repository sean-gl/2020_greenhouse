...
rm(list = ls())
wd <- "/home/sean/github/2020_greenhouse/second_fall_experiment/data/scale_output/read_only/post_experiment_data/"
setwd(wd)
...
saveRDS(ww, '/home/sean/github/2020_greenhouse/second_fall_experiment/scripts/clay_R_scripts/analysis/mass_balance_saturated_pot_weights.rds')

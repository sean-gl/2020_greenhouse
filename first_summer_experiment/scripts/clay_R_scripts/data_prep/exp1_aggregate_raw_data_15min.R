...
setwd("/home/wmsru/github/2020_greenhouse/first_summer_experiment/figures")
# on U drive
...
rh1 <- read.table(paste("/home/wmsru/github/2020_greenhouse/first_summer_experiment//",
                        "data/RH_temp_PAR_logger_data/read_only/collected_8_23_2019.TXT", sep=""), header = F, sep = ",")
rh2 <- read.table(paste("/home/wmsru/github/2020_greenhouse/first_summer_experiment/",
...
write.csv(rh, paste("/home/wmsru/github/2020_greenhouse/first_summer_experiment/",
...
# export to file
write.csv(comb, paste("/home/wmsru/github/2020_greenhouse/first_summer_experiment/",
...
wind1 <- read.table(paste("/home/wmsru/github/2020_greenhouse/first_summer_experiment/",
                          "data/wind_sensor_data/read_only/downloaded_8_23_2019.TXT", sep=""), header = F, sep = ",")
wind2 <- read.table(paste("/home/wmsru/github/2020_greenhouse/first_summer_experiment/",
...
temp <- read.csv(paste("/home/wmsru/github/2020_greenhouse/first_summer_experiment/",
...
write.csv(stacked, paste("/home/wmsru/github/2020_greenhouse/first_summer_experiment/",
...
lq1 <- read.csv(paste("/home/wmsru/github/2020_greenhouse/first_summer_experiment/",
                      "data/line_PAR_sensors/read_only/11_4_2019_east.csv", sep=""), sep=",", header=T)
lq1$east_west <-'east'
lq2 <- read.csv(paste("/home/wmsru/github/2020_greenhouse/first_summer_experiment/",
                      "data/line_PAR_sensors/read_only/11_4_2019_west.csv", sep=""), sep=",", header=T)
lq2$east_west <- 'west'
lq3 <- read.csv(paste("/home/wmsru/github/2020_greenhouse/first_summer_experiment/",
                      "data/line_PAR_sensors/read_only/11_19_2019_east.csv", sep=""), sep=",", header=T)
lq3$east_west <- 'east'
lq4 <- read.csv(paste("/home/wmsru/github/2020_greenhouse/first_summer_experiment/",
                      "data/line_PAR_sensors/read_only/11_19_2019_west.csv", sep=""), sep=",", header=T)
lq4$east_west <- 'west'
lq5 <- read.csv(paste("/home/wmsru/github/2020_greenhouse/first_summer_experiment/",
                      "data/line_PAR_sensors/read_only/12_5_2019_east.csv", sep=""), sep=",", header=T)
lq5$east_west <- 'east'
lq6 <- read.csv(paste("/home/wmsru/github/2020_greenhouse/first_summer_experiment/",
                      "data/line_PAR_sensors/read_only/12_5_2019_west.csv", sep=""), sep=",", header=T)
lq6$east_west <- 'west'
lq7 <- read.csv(paste("/home/wmsru/github/2020_greenhouse/first_summer_experiment/",
                      "data/line_PAR_sensors/read_only/12_12_2019_east.csv", sep=""), sep=",", header=T)
lq7$east_west <- 'east'
lq8 <- read.csv(paste("/home/wmsru/github/2020_greenhouse/first_summer_experiment/",
